...
const lenders = [
  {
    ...
    maxLtv: "50%",
    minRate: "5.49%",
    features: ["SSAS accepted", "25yr terms"],
  },
  {
    name: "Shawbrook Bank",
    maxLtv: "50%",
    minRate: "5.99%",
    features: ["SSAS accepted", "Fast turnaround"],
  },
  {
    name: "Redwood Bank",
    maxLtv: "50%",
    minRate: "5.75%",
    features: ["SSAS accepted", "Dedicated RM"],
  },
  {
    name: "Aldermore",
    maxLtv: "50%",
    minRate: "5.89%",
    features: ["SSAS accepted", "Multi-property"],
  },
  {
    name: "Hampshire Trust",
    maxLtv: "50%",
    minRate: "6.25%",
    features: ["SSAS specialist", "Competitive rates"],
  },
  {
    name: "Paragon Bank",
    maxLtv: "50%",
    minRate: "5.69%",
    features: ["SSAS accepted", "Large loans"],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/50 max-w-2xl mx-auto">
            We work with the UK&apos;s leading SSAS commercial property
