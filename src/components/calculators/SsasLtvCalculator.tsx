...
export function SsasLtvCalculatorClient() {
  const [propertyValue, setPropertyValue] = useState(500000);
  const [fundValue, setFundValue] = useState(400000);

  const results = calculateSsasLtv({
    propertyValue,
    ssasFundValue: fundValue,
  });
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="glass-card p-5">
            <p className="text-xs text-white/40 mb-1">SSAS Deposit</p>
        ...
        <div className="glass-card p-6">
          ...
          <p className="text-xs text-white/30 mt-1">
            Maximum property value your SSAS can target
          </p>
        </div>
        ...
        {!results.fundSufficient && (
          <div className="glass-card p-4 border-red-500/30">
            <p className="text-sm text-red-400">
              Your SSAS fund of {fmt(fundValue)} is insufficient for the 50%
